WITH
    ...
    creators AS (
        ...
        WHERE
            ...
            AND LOWER(from_address) IN (
                ...
                '0x18e433c7bf8a2e1d0197ce5d8f9afada1a771360',
                '0xdaf819c2437a82f9e01f6586207ebf961a7f0970',
                '0x3032ab3fa8c01d786d29dade018d7f2017918e12', -- creators of the official contracts
                '0x4e59b44847b379578588920ca78fbf26c0b4956c',
                '0xe60ae42e7497f488ea682270e0918d3677bb637d',
                '0xcf2a39493f5193e8ee0d0e8dbf78a92a4ef293c4',
                '0x48e516b34a1274f49457b9c6182097796d0498cb',
                '0x41653c7d61609d856f29355e404f310ec4142cfb',
                '0xd1c24f50d05946b3fabefbae3cd0a7e9938c63f2',
    ...
    same_creators AS (
        ...
        FROM
            top_n_calls t
            JOIN creators c ON c.to_address = t.to_address
    )
SELECT
    from_address,
    to_address
