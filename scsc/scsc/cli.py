...
@click.option('--from-block', required=True, type=str, help='Starting block number')
@click.option('--to-block', required=True, type=str, help='Ending block number')
...
def main(url, address, from_block, to_block, export_dot, export_json, log_level):
