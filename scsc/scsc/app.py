...
sc = SupplyChain(
    "http://localhost:8545", "0xE592427A0AEce92De3Edee1F18E0157C05861564"
)
...
called_contracts = sc.cg.G.nodes() - {source_node}
...
default_stylesheet = [
    {
        "selector": "node",
        "style": {"opacity": 0.65, "z-index": 9999, "label": "data(label)"},
    },
    {
